  ...
  static Future<bool> validateAccessToken(User user) async {
    assert(
        user.accessToken != null && user.accessToken.isNotEmpty &&
            user.refreshToken != null && user.refreshToken.isNotEmpty &&
            user.validUntil != null,
        'Tokens are not valid');

    log(user.accessToken, name:'access_token');
    ...
    return jsonBody['success'] != null && jsonBody['success'] && jsonBody['userId'] == user.userId && jsonBody['emailVerified'];
  }
